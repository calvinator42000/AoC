        ...
        for i in range(len(start)):
            if i+len(element) <= len(start) and start[i:i+len(element)] == element:
                ...
                if not new_molecule in generation:
                    #print("Depth: " + str(len(generation)))
                    #print("Current Target: " + start)
                    #print("Current Replacement: " + element + " => " + replacement)
                    #print("Current Generation: " + new_molecule)
                    #print()
                    generateMolecule(new_molecule, goal, replacement_list, generation + [new_molecule], generation_list, black_list)
